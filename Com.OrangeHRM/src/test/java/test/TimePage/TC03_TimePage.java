...
public class TC03_TimePage extends BaseClass{

    @Test
    public void verifyInvalidBackdatedPunchInOut() {
        try {
            logger.info("  TC03_TimePage Started  ");
            ...
            String backDate = new SimpleDateFormat("yyyy-dd-MM").format(calendar.getTime());
      
            BasePage.InputText(tp.dateField, backDate);  
            logger.info("Entered backdated date: " + backDate);
            Thread.sleep(5000);
            ...
            logger.info("  TC03_TimePage Completed  ");
